...
export default function AdminDashboard({user,roleLabel,allowed,signout}:Props){const[tab,setTab]=useState("डैशबोर्ड");
  ...
  useEffect(() => {
    const handleOpen = (e: any) => { setEditArticleItem(rawArticles[e.detail]); };
