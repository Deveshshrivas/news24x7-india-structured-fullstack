...
type Reporter={id:string;reporterId?:string;name:string;designation:string;phone:string;email:string;country:string;state:string;city:string;pincode:string;address:string;active:boolean;photoUrl:string|null};
type Language="hi"|"en";
