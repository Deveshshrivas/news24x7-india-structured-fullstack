...
export default function SettingsManager({
  ...
  if (loading) {
    return <section className="workspace"><div className="workspaceHead"><div><h2>{localize(language,"वेबसाइट सेटिंग्स","Website settings")}</h2></div></div><div style={{padding: 20}}>{localize(language,"लोड हो रहा है…","Loading…")}</div></section>;
  }
          ...
          <div>
            <label>
              ...
              <small className="settingHint">
                {localize(
                  language,
                  "यह भाषा केवल इसी ब्राउज़र में सेव रहेगी।",
