...
const collections=['articles','categories','users','reporters','audio_tracks','breaking_news','oauth_codes','reading_sessions','site_settings','local_uploads','audio_files.files','audio_files.chunks','article_images.files','article_images.chunks','reporter_photos.files','reporter_photos.chunks'];
